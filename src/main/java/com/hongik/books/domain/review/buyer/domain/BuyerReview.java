package com.hongik.books.domain.review.buyer.domain;
...
@Table(name = "buyer_reviews",
       uniqueConstraints = {
           @UniqueConstraint(name = "uk_reviewer_post_buyer", columnNames = {"reviewer_id", "post_id"})
       })
...
public class BuyerReview {
    ...
    @Builder
    public BuyerReview(User buyer, User reviewer, SalePost salePost,
